...
export const scythiansBarbarian: BotTable = [
  { if: Icon.ATTACK, then: [E.DISCARD_2_CARDS, E.YOU_RECALL_REGION, 'If you are an {empire}, steal 1 {population}.'] },
  { if: 'Conquer', then: E.FIRST_OF([E.SPEND_4_P_TO_BREAK_THROUGH_FOR_TRIBUTARY, E.ACQUIRE_REGION, E.GAIN_1_P]) },
  { if: 'Advance', then: E.FIRST_OF([E.SPEND_4_M_TO_BREAK_THROUGH_FOR_CIVILISED, E.ACQUIRE_UNCIV, E.GAIN_1_M]) },
  { if: Suit.REGION, then: [E.GAIN_1_P, E.PLAY_REGION, E.EXILE_FROM_MARKET] },
  { if: Icon.PINNED, then: [E.DISCARD_2_CARDS, E.GAIN_2_M, E.PUT_INTO_HISTORY] },
...
export const scythiansEmpire: BotTable = [
  ...
  { if: Icon.ATTACK, then: [E.GAIN_2_M, E.YOU_DISCARD_1_CARD] },
  { if: State.EMPIRE, then: [E.GAIN_1_PROGRESS, E.PUT_INTO_HISTORY] },
  { if: 'Other', then: E.FIRST_OF([[E.SPEND_3_P_TO_BREAK_THROUGH_FOR_TRIBUTARY, E.PUT_INTO_HISTORY], [E.GAIN_1_P, E.ACQUIRE_REGION]]) },
];
