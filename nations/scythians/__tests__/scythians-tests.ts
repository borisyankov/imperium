...
describe('Scythians', () => {
  test('there are 24 Scythians cards', () => {
  ...
  test('there are 13 cards with no suit', () => {
    const cardsWithNoSuit = cards.filter(card => card.suit === undefined);
    expect(cardsWithNoSuit.length).toEqual(13);
  });
  ...
  test('there are 14 cards with no state', () => {
    const cardsWithNoState = cards.filter(card => card.state === undefined);
    expect(cardsWithNoState.length).toEqual(14);
  });
  ...
  test('there are 3 cards with Empire state', () => {
  ...
  test('there are 7 cards in Nation deck', () => {
  ...
  test('there are 4 cards in Development deck', () => {
